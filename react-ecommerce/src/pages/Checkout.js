   ...
   <div className='lg:col-span-3'>
    ...
    <form className="bg-white px-5 py-12 mt-12">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-2                                                                                                 xl font-semibold leading-7 text-gray-900">
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-20">
